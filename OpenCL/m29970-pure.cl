...
KERNEL_FQ KERNEL_FA void m29970_init (KERN_ATTR_TMPS (cmiyc_tmp_t))
{
...
KERNEL_FQ KERNEL_FA void m29970_loop (KERN_ATTR_TMPS (cmiyc_tmp_t))
{
  const u64 gid = get_global_id (0);
...
KERNEL_FQ KERNEL_FA void m29970_comp (KERN_ATTR_TMPS (cmiyc_tmp_t))
{
  const u64 gid = get_global_id (0);
