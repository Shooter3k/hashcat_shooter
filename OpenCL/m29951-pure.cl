#define PHPBB3_BCRYPT_PREHASH_MD5 1
...
KERNEL_FQ KERNEL_FA void m29951_init (KERN_ATTR_TMPS (phpbb3_bcrypt_tmp_t))
{
...
KERNEL_FQ KERNEL_FA void m29951_loop (KERN_ATTR_TMPS (phpbb3_bcrypt_tmp_t))
{
  const u64 gid = get_global_id (0);
...
KERNEL_FQ KERNEL_FA void m29951_init2 (KERN_ATTR_TMPS (phpbb3_bcrypt_tmp_t))
{
  const u64 gid = get_global_id (0);
...
KERNEL_FQ KERNEL_FA void m29951_loop2 (KERN_ATTR_TMPS (phpbb3_bcrypt_tmp_t))
{
  const u64 gid = get_global_id (0);
  const u64 lid = get_local_id (0);
...
KERNEL_FQ KERNEL_FA void m29951_comp (KERN_ATTR_TMPS (phpbb3_bcrypt_tmp_t))
{
  const u64 gid = get_global_id (0);
  const u64 lid = get_local_id (0);
