...
u32 brain_compute_attack (hashcat_ctx_t *hashcat_ctx)
{
  ...
  else if (user_options->attack_mode == ATTACK_MODE_COMBI3)
  {
    const u64 wordlist1_hash = brain_compute_attack_wordlist (combinator_ctx->dict1);
    const u64 wordlist2_hash = brain_compute_attack_wordlist (combinator_ctx->dict2);
    const u64 wordlist3_hash = brain_compute_attack_wordlist (combinator_ctx->dict3);

    XXH64_update (state, &wordlist1_hash, sizeof (wordlist1_hash));
    XXH64_update (state, &wordlist2_hash, sizeof (wordlist2_hash));
    XXH64_update (state, &wordlist3_hash, sizeof (wordlist3_hash));
  ...
  else if (user_options->attack_mode == ATTACK_MODE_COMBI4)
  {
    const u64 wordlist1_hash = brain_compute_attack_wordlist (combinator_ctx->dict1);
    const u64 wordlist2_hash = brain_compute_attack_wordlist (combinator_ctx->dict2);
    const u64 wordlist3_hash = brain_compute_attack_wordlist (combinator_ctx->dict3);
    const u64 wordlist4_hash = brain_compute_attack_wordlist (combinator_ctx->dict4);

    XXH64_update (state, &wordlist1_hash, sizeof (wordlist1_hash));
    XXH64_update (state, &wordlist2_hash, sizeof (wordlist2_hash));
    XXH64_update (state, &wordlist3_hash, sizeof (wordlist3_hash));
    XXH64_update (state, &wordlist4_hash, sizeof (wordlist4_hash));
