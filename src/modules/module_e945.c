/**
 * Auto-generated mdxfind alias module: e945 APFS
...
#include "module_18300.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e945 APFS";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (945);
}
