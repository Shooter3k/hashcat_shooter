/**
 * Auto-generated mdxfind alias module: e825 SHA256SALTPASSSALT
...
#include "module_22300.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e825 SHA256SALTPASSSALT";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (825);
}
