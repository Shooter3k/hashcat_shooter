/**
 * Auto-generated mdxfind alias module: e164 SHA256MD5
...
#include "module_20800.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e164 SHA256MD5";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (164);
}
