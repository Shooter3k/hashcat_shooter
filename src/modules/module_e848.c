/**
 * Auto-generated mdxfind alias module: e848 DESENCRYPT
...
#include "module_14000.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e848 DESENCRYPT";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (848);
}
