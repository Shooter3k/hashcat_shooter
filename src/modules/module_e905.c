/**
 * Auto-generated mdxfind alias module: e905 REDHAT389DS
...
#include "module_10901.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e905 REDHAT389DS";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (905);
}
