/**
 * Auto-generated mdxfind alias module: e971 KRB5DB18
...
#include "module_28900.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e971 KRB5DB18";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (971);
}
