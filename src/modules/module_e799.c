/**
 * Auto-generated mdxfind alias module: e799 HMAC-RMD320-KPASS
...
#include "module_33650.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e799 HMAC-RMD320-KPASS";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (799);
}
