/**
 * Auto-generated mdxfind alias module: e820 MD5-MD5SALT-MD5MD5PASS
...
#include "module_30500.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e820 MD5-MD5SALT-MD5MD5PASS";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (820);
}
