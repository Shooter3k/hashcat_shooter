/**
 * Auto-generated mdxfind alias module: e955 MONGODB-SHA1
...
#include "module_24100.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e955 MONGODB-SHA1";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (955);
}
