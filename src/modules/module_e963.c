/**
 * Auto-generated mdxfind alias module: e963 AES128-NOKDF
...
#include "module_26401.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e963 AES128-NOKDF";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (963);
}
