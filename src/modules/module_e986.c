/**
 * Auto-generated mdxfind alias module: e986 AS400SSHA1
...
#include "module_35200.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e986 AS400SSHA1";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (986);
}
