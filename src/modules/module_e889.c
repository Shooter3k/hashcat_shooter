/**
 * Auto-generated mdxfind alias module: e889 WERKZEUG-MD5
...
#include "module_30000.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e889 WERKZEUG-MD5";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (889);
}
