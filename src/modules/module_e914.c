/**
 * Auto-generated mdxfind alias module: e914 KRB5TGS23
...
#include "module_13100.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e914 KRB5TGS23";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (914);
}
