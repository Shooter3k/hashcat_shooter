/**
 * Auto-generated mdxfind alias module: e850 MSSQL2000
...
#include "module_00131.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e850 MSSQL2000";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (850);
}
