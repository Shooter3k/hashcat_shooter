/**
 * Auto-generated mdxfind alias module: e890 WERKZEUG-SHA256
...
#include "module_30120.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e890 WERKZEUG-SHA256";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (890);
}
