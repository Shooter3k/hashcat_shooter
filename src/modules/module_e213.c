/**
 * Auto-generated mdxfind alias module: e213 HMAC-RMD320
...
#include "module_33660.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e213 HMAC-RMD320";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (213);
}
