/**
 * Auto-generated mdxfind alias module: e411 MD5SALTPASSSALT
...
#include "module_03800.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e411 MD5SALTPASSSALT";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (411);
}
