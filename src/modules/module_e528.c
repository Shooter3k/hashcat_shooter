/**
 * Auto-generated mdxfind alias module: e528 MD5-SALTSHA1SALTPASS
...
#include "module_21300.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e528 MD5-SALTSHA1SALTPASS";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (528);
}
