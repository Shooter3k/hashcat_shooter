/**
 * Auto-generated mdxfind alias module: e846 BLAKE2B256PASSSALT
...
#include "module_34810.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e846 BLAKE2B256PASSSALT";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (846);
}
