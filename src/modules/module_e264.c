/**
 * Auto-generated mdxfind alias module: e264 RADMIN2
...
#include "module_09900.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e264 RADMIN2";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (264);
}
