/**
 * Auto-generated mdxfind alias module: e888 ISCSI-CHAP
...
#include "module_04800.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e888 ISCSI-CHAP";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (888);
}
