/**
 * Auto-generated mdxfind alias module: e727 SHA1UTF16LE
...
#include "module_00170.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e727 SHA1UTF16LE";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (727);
}
