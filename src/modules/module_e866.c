/**
 * Auto-generated mdxfind alias module: e866 CISCOISE
...
#include "module_05720.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e866 CISCOISE";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (866);
}
