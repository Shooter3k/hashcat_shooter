/**
 * Auto-generated mdxfind alias module: e950 SOLARWINDS2
...
#include "module_21501.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e950 SOLARWINDS2";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (950);
}
