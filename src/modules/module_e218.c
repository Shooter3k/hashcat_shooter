/**
 * Auto-generated mdxfind alias module: e218 HMAC-SHA512
...
#include "module_01760.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e218 HMAC-SHA512";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (218);
}
