/**
 * Auto-generated mdxfind alias module: e854 MACOSX7
...
#include "module_01722.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e854 MACOSX7";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (854);
}
