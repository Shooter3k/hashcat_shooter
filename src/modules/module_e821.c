/**
 * Auto-generated mdxfind alias module: e821 MD5-MD5MD5PASSSALT-PEP2
...
#include "module_21900.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e821 MD5-MD5MD5PASSSALT-PEP2";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (821);
}
