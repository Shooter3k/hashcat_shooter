/**
 * Auto-generated mdxfind alias module: e534 PKCS5S2
...
#include "module_12001.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e534 PKCS5S2";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (534);
}
