 ...
 *
 * Mode 29970 is a local/private number.  HashMob's public algorithm identifier
...
static const char *HASH_NAME      = "CMIYC 2026 memory-hard SHA-512 [GPU/private]";
static const u64   KERN_TYPE      = 29970;
