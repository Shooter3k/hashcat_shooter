/**
 * Auto-generated mdxfind alias module: e972 MURMUR3
...
#include "module_27800.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e972 MURMUR3";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (972);
}
