/**
 * Auto-generated mdxfind alias module: e856 JUNIPERSSG
...
#include "module_00022.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e856 JUNIPERSSG";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (856);
}
