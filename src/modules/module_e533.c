/**
 * Auto-generated mdxfind alias module: e533 PBKDF2-SHA512
...
#include "module_07100.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e533 PBKDF2-SHA512";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (533);
}
