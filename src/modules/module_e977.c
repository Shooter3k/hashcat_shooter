/**
 * Auto-generated mdxfind alias module: e977 SSPR-SHA1S
...
#include "module_32020.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e977 SSPR-SHA1S";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (977);
}
