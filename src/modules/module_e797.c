/**
 * Auto-generated mdxfind alias module: e797 HMAC-SHA512-KPASS
...
#include "module_01750.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e797 HMAC-SHA512-KPASS";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (797);
}
