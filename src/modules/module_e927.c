/**
 * Auto-generated mdxfind alias module: e927 PS-TOKEN
...
#include "module_13500.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e927 PS-TOKEN";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (927);
}
