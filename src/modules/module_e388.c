/**
 * Auto-generated mdxfind alias module: e388 SHA512SALTPASS
...
#include "module_01720.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e388 SHA512SALTPASS";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (388);
}
