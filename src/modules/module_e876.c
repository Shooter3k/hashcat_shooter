/**
 * Auto-generated mdxfind alias module: e876 DRUPAL7
...
#include "module_07900.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e876 DRUPAL7";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (876);
}
