/**
 * Auto-generated mdxfind alias module: e827 WRLSALTPASSSALT
...
#include "module_32600.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e827 WRLSALTPASSSALT";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (827);
}
