/**
 * Auto-generated mdxfind alias module: e878 NETSCALER
...
#include "module_08100.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e878 NETSCALER";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (878);
}
