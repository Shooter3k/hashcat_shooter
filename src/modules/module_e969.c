/**
 * Auto-generated mdxfind alias module: e969 AWSSIGV4
...
#include "module_28700.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e969 AWSSIGV4";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (969);
}
