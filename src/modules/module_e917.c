/**
 * Auto-generated mdxfind alias module: e917 CISCO9
...
#include "module_09300.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e917 CISCO9";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (917);
}
