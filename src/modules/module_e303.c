/**
 * Auto-generated mdxfind alias module: e303 MD5-2xMD5
...
#include "module_03500.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e303 MD5-2xMD5";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (303);
}
