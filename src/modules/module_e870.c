/**
 * Auto-generated mdxfind alias module: e870 AIX-SHA256
...
#include "module_06400.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e870 AIX-SHA256";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (870);
}
