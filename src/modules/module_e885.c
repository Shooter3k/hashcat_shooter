/**
 * Auto-generated mdxfind alias module: e885 JUNIPERIVE
...
#include "module_00501.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e885 JUNIPERIVE";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (885);
}
