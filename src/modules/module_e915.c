/**
 * Auto-generated mdxfind alias module: e915 AXCRYPT
...
#include "module_13200.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e915 AXCRYPT";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (915);
}
