/**
 * Auto-generated mdxfind alias module: e946 OTM-SHA256
...
#include "module_20600.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e946 OTM-SHA256";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (946);
}
