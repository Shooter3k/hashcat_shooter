/**
 * Auto-generated mdxfind alias module: e988 SM3
...
#include "module_31100.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e988 SM3";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (988);
}
