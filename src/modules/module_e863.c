/**
 * Auto-generated mdxfind alias module: e863 MEDIAWIKI
...
#include "module_03711.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e863 MEDIAWIKI";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (863);
}
