/**
 * Auto-generated mdxfind alias module: e792 HMAC-MD5-KPASS
...
#include "module_00050.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e792 HMAC-MD5-KPASS";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (792);
}
