/**
 * Auto-generated mdxfind alias module: e908 SHIRO1
...
#include "module_12150.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e908 SHIRO1";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (908);
}
