/**
 * Auto-generated mdxfind alias module: e976 SSPR-SHA1
...
#include "module_32010.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e976 SSPR-SHA1";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (976);
}
