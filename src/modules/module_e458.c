/**
 * Auto-generated mdxfind alias module: e458 MD5-MD5PASSMD5SALT
...
#include "module_03910.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e458 MD5-MD5PASSMD5SALT";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (458);
}
