/**
 * Auto-generated mdxfind alias module: e802 MD5UTF16LESALTPASS
...
#include "module_00040.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e802 MD5UTF16LESALTPASS";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (802);
}
