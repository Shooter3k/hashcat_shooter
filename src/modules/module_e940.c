/**
 * Auto-generated mdxfind alias module: e940 KRB5PA-17
...
#include "module_19800.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e940 KRB5PA-17";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (940);
}
