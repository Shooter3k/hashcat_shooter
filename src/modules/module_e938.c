/**
 * Auto-generated mdxfind alias module: e938 SHA1-S1PS2
...
#include "module_19300.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e938 SHA1-S1PS2";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (938);
}
