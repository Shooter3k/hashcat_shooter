/**
 * Auto-generated mdxfind alias module: e516 MD5-SALTMD5SALTPASS
...
#include "module_04010.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e516 MD5-SALTMD5SALTPASS";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (516);
}
