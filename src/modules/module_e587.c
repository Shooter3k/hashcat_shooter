/**
 * Auto-generated mdxfind alias module: e587 SHA1MD5SALT
...
#include "module_04710.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e587 SHA1MD5SALT";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (587);
}
