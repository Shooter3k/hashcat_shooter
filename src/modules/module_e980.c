/**
 * Auto-generated mdxfind alias module: e980 EMPIRECMS
...
#include "module_32300.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e980 EMPIRECMS";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (980);
}
