/**
 * Auto-generated mdxfind alias module: e990 WPA-PMK
...
#include "module_22001.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e990 WPA-PMK";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (990);
}
