/**
 * Auto-generated mdxfind alias module: e816 RMD320
...
#include "module_33600.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e816 RMD320";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (816);
}
