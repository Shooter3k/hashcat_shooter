/**
 * Auto-generated mdxfind alias module: e536 PROGRESSENCODE
...
#include "module_26200.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e536 PROGRESSENCODE";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (536);
}
