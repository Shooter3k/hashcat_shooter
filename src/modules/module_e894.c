/**
 * Auto-generated mdxfind alias module: e894 SHA1SHA1SALTPASSSALT
...
#include "module_05000.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e894 SHA1SHA1SALTPASSSALT";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (894);
}
