/**
 * Auto-generated mdxfind alias module: e882 DOMINO5
...
#include "module_08600.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e882 DOMINO5";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (882);
}
