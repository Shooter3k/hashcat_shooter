/**
 * Auto-generated mdxfind alias module: e982 MSONLINE
...
#include "module_33700.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e982 MSONLINE";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (982);
}
