/**
 * Auto-generated mdxfind alias module: e439 MSCACHE
...
#include "module_01100.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e439 MSCACHE";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (439);
}
