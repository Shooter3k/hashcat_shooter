/**
 * Auto-generated mdxfind alias module: e891 AUTHME
...
#include "module_20711.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e891 AUTHME";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (891);
}
