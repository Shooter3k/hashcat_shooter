/**
 * Auto-generated mdxfind alias module: e382 SHA256SHA256SALT
...
#include "module_20710.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e382 SHA256SHA256SALT";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (382);
}
