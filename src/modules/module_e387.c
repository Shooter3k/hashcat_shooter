/**
 * Auto-generated mdxfind alias module: e387 SHA512SHA512SALT
...
#include "module_32410.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e387 SHA512SHA512SALT";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (387);
}
