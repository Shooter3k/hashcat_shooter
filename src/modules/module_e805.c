/**
 * Auto-generated mdxfind alias module: e805 SHA256UTF16LE
...
#include "module_01470.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e805 SHA256UTF16LE";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (805);
}
