/**
 * Auto-generated mdxfind alias module: e967 BCRYPTSHA512
...
#include "module_28400.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e967 BCRYPTSHA512";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (967);
}
