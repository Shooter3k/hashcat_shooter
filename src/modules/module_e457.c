/**
 * Auto-generated mdxfind alias module: e457 APACHE-SHA
...
#include "module_00101.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e457 APACHE-SHA";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (457);
}
