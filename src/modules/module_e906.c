/**
 * Auto-generated mdxfind alias module: e906 POSTGRESCRAM
...
#include "module_11100.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e906 POSTGRESCRAM";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (906);
}
