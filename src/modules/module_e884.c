/**
 * Auto-generated mdxfind alias module: e884 SCRYPT
...
#include "module_08900.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e884 SCRYPT";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (884);
}
