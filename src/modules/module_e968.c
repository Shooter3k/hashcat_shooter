/**
 * Auto-generated mdxfind alias module: e968 POSTGRESSCRAM256
...
#include "module_28600.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e968 POSTGRESSCRAM256";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (968);
}
