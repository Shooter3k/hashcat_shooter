/**
 * Auto-generated mdxfind alias module: e804 SHA1UTF16LESALTPASS
...
#include "module_00140.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e804 SHA1UTF16LESALTPASS";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (804);
}
