/**
 * Auto-generated mdxfind alias module: e836 SSHA512BASE64
...
#include "module_01711.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e836 SSHA512BASE64";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (836);
}
