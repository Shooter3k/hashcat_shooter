/**
 * Auto-generated mdxfind alias module: e8 SHA1
...
#include "module_00100.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e8 SHA1";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (8);
}
