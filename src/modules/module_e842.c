/**
 * Auto-generated mdxfind alias module: e842 BLAKE2B512PASSSALT
...
#include "module_00610.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e842 BLAKE2B512PASSSALT";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (842);
}
