/**
 * Auto-generated mdxfind alias module: e217 HMAC-SHA256
...
#include "module_01460.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e217 HMAC-SHA256";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (217);
}
