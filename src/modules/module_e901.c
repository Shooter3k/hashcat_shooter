/**
 * Auto-generated mdxfind alias module: e901 DOMINO8
...
#include "module_09100.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e901 DOMINO8";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (901);
}
