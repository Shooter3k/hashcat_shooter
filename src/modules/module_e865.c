/**
 * Auto-generated mdxfind alias module: e865 CISCO4
...
#include "module_05700.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e865 CISCO4";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (865);
}
