/**
 * Auto-generated mdxfind alias module: e862 CISCOASA
...
#include "module_02410.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e862 CISCOASA";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (862);
}
