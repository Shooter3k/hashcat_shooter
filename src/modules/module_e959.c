/**
 * Auto-generated mdxfind alias module: e959 DAHUA-AUTH
...
#include "module_24900.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e959 DAHUA-AUTH";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (959);
}
