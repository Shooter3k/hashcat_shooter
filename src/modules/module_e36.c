/**
 * Auto-generated mdxfind alias module: e36 SHA256RAW
...
#include "module_21400.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e36 SHA256RAW";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (36);
}
