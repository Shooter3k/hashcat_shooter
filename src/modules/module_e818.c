/**
 * Auto-generated mdxfind alias module: e818 MD5-SALTMD5PASS-SALT
...
#include "module_33100.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e818 MD5-SALTMD5PASS-SALT";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (818);
}
