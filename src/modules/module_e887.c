/**
 * Auto-generated mdxfind alias module: e887 ARUBAOS
...
#include "module_00125.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e887 ARUBAOS";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (887);
}
