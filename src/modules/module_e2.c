/**
 * Auto-generated mdxfind alias module: e2 MD5UC
...
#include "module_04300.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e2 MD5UC";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (2);
}
