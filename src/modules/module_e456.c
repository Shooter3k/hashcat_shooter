/**
 * Auto-generated mdxfind alias module: e456 MYSQL3
...
#include "module_00200.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e456 MYSQL3";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (456);
}
