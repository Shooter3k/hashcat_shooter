/**
 * Auto-generated mdxfind alias module: e898 NETNTLMV2
...
#include "module_05600.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e898 NETNTLMV2";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (898);
}
