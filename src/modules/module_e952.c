/**
 * Auto-generated mdxfind alias module: e952 APPLE-KEYCHAIN
...
#include "module_23100.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e952 APPLE-KEYCHAIN";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (952);
}
