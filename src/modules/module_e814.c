/**
 * Auto-generated mdxfind alias module: e814 SHA384UTF16LEPASSSALT
...
#include "module_10830.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e814 SHA384UTF16LEPASSSALT";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (814);
}
