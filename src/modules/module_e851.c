/**
 * Auto-generated mdxfind alias module: e851 MSSQL2005
...
#include "module_00132.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e851 MSSQL2005";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (851);
}
