/**
 * Auto-generated mdxfind alias module: e822 MD5-SALT-SHA1PEPPASS
...
#include "module_21310.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e822 MD5-SALT-SHA1PEPPASS";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (822);
}
