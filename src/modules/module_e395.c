/**
 * Auto-generated mdxfind alias module: e395 SHA1SALTPASSSALT
...
#include "module_04900.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e395 SHA1SALTPASSSALT";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (395);
}
