/**
 * Auto-generated mdxfind alias module: e983 WBB4
...
#include "module_33800.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e983 WBB4";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (983);
}
