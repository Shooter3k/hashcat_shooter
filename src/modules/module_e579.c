/**
 * Auto-generated mdxfind alias module: e579 SHA1SHA1PASSSALT
...
#include "module_04521.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e579 SHA1SHA1PASSSALT";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (579);
}
