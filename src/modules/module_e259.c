/**
 * Auto-generated mdxfind alias module: e259 SQL5
...
#include "module_00300.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e259 SQL5";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (259);
}
