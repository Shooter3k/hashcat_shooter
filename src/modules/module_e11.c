/**
 * Auto-generated mdxfind alias module: e11 SHA384
...
#include "module_10800.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e11 SHA384";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (11);
}
