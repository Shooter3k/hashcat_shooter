/**
 * Auto-generated mdxfind alias module: e515 MD5-SALTMD5PASSSALT
...
#include "module_04110.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e515 MD5-SALTMD5PASSSALT";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (515);
}
