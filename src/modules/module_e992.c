/**
 * Auto-generated mdxfind alias module: e992 SYMFONY256
...
#include "module_35800.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e992 SYMFONY256";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (992);
}
