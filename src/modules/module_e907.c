/**
 * Auto-generated mdxfind alias module: e907 MYSQLCRAM
...
#include "module_11200.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e907 MYSQLCRAM";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (907);
}
