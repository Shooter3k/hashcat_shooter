/**
 * Auto-generated mdxfind alias module: e443 MD5SHA1PASSSALT
...
#include "module_04420.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e443 MD5SHA1PASSSALT";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (443);
}
