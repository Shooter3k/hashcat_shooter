/**
 * Auto-generated mdxfind alias module: e912 AZURESYNC
...
#include "module_12800.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e912 AZURESYNC";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (912);
}
