/**
 * Auto-generated mdxfind alias module: e801 MD5UTF16LEPASSSALT
...
#include "module_00030.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e801 MD5UTF16LEPASSSALT";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (801);
}
