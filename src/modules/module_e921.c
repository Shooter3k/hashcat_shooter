/**
 * Auto-generated mdxfind alias module: e921 IKEPSK-SHA1
...
#include "module_05400.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e921 IKEPSK-SHA1";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (921);
}
