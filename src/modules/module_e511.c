/**
 * Auto-generated mdxfind alias module: e511 MD5CRYPT
...
#include "module_00500.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e511 MD5CRYPT";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (511);
}
