/**
 * Auto-generated mdxfind alias module: e819 MD5-MD5MD5PASSSALT-PEP
...
#include "module_31700.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e819 MD5-MD5MD5PASSSALT-PEP";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (819);
}
