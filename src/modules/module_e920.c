/**
 * Auto-generated mdxfind alias module: e920 IKEPSK-MD5
...
#include "module_05300.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e920 IKEPSK-MD5";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (920);
}
