/**
 * Auto-generated mdxfind alias module: e868 AIX-MD5
...
#include "module_06300.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e868 AIX-MD5";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (868);
}
