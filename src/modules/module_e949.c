/**
 * Auto-generated mdxfind alias module: e949 SOLARWINDS
...
#include "module_21500.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e949 SOLARWINDS";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (949);
}
