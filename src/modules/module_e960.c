/**
 * Auto-generated mdxfind alias module: e960 BESDER-AUTH
...
#include "module_24901.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e960 BESDER-AUTH";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (960);
}
