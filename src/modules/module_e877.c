/**
 * Auto-generated mdxfind alias module: e877 SYBASE-ASE
...
#include "module_08000.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e877 SYBASE-ASE";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (877);
}
