/**
 * Auto-generated mdxfind alias module: e310 SHA1SHA1USER
...
#include "module_04510.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e310 SHA1SHA1USER";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (310);
}
