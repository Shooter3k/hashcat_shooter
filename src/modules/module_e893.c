/**
 * Auto-generated mdxfind alias module: e893 NETSCALER-SHA512
...
#include "module_22200.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e893 NETSCALER-SHA512";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (893);
}
