/**
 * Auto-generated mdxfind alias module: e900 FORTIGATE
...
#include "module_07000.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e900 FORTIGATE";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (900);
}
