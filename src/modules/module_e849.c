/**
 * Auto-generated mdxfind alias module: e849 DES3ENCRYPT
...
#include "module_14100.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e849 DES3ENCRYPT";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (849);
}
