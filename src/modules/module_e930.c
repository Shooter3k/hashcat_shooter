/**
 * Auto-generated mdxfind alias module: e930 TACACS
...
#include "module_16100.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e930 TACACS";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (930);
}
