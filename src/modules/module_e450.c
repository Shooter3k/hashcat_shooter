/**
 * Auto-generated mdxfind alias module: e450 BCRYPT
...
#include "module_03200.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e450 BCRYPT";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (450);
}
