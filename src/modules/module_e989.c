/**
 * Auto-generated mdxfind alias module: e989 BCRYPTHMACSHA256
...
#include "module_30601.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e989 BCRYPTHMACSHA256";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (989);
}
