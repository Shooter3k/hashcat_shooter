/**
 * Auto-generated mdxfind alias module: e892 NETWITNESS
...
#include "module_20712.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e892 NETWITNESS";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (892);
}
