/**
 * Auto-generated mdxfind alias module: e807 SHA256UTF16LESALTPASS
...
#include "module_01440.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e807 SHA256UTF16LESALTPASS";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (807);
}
