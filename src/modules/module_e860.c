/**
 * Auto-generated mdxfind alias module: e860 HMAILSERVER
...
#include "module_01421.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e860 HMAILSERVER";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (860);
}
