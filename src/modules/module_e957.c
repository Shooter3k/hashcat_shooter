/**
 * Auto-generated mdxfind alias module: e957 FORTIGATE256
...
#include "module_26300.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e957 FORTIGATE256";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (957);
}
