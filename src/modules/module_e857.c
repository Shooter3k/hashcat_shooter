/**
 * Auto-generated mdxfind alias module: e857 SKYPE
...
#include "module_00023.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e857 SKYPE";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (857);
}
