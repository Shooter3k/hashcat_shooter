/**
 * Auto-generated mdxfind alias module: e555 MD5SHA1SALT
...
#include "module_04410.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e555 MD5SHA1SALT";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (555);
}
