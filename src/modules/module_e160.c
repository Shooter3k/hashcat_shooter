/**
 * Auto-generated mdxfind alias module: e160 SHA1MD5
...
#include "module_04700.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e160 SHA1MD5";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (160);
}
