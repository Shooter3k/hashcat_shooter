/**
 * Auto-generated mdxfind alias module: e405 SHA1PASSSALT
...
#include "module_00110.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e405 SHA1PASSSALT";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (405);
}
