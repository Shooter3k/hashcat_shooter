/**
 * Auto-generated mdxfind alias module: e31 MD5SALT
...
#include "module_02611.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e31 MD5SALT";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (31);
}
