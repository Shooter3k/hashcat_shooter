/**
 * Auto-generated mdxfind alias module: e13 GOST
...
#include "module_06900.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e13 GOST";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (13);
}
