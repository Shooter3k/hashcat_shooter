/**
 * Auto-generated mdxfind alias module: e308 SHA1MD5USER
...
#include "module_04711.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e308 SHA1MD5USER";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (308);
}
