/**
 * Auto-generated mdxfind alias module: e373 MD5PASSSALT
...
#include "module_00010.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e373 MD5PASSSALT";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (373);
}
