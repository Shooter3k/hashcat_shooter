/**
 * Auto-generated mdxfind alias module: e919 PWSAFE3
...
#include "module_05200.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e919 PWSAFE3";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (919);
}
