/**
 * Auto-generated mdxfind alias module: e367 MD5-MD5SALTMD5PASS
...
#include "module_02811.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e367 MD5-MD5SALTMD5PASS";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (367);
}
