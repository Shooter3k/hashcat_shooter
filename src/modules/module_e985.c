/**
 * Auto-generated mdxfind alias module: e985 SM3CRYPT
...
#include "module_35100.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e985 SM3CRYPT";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (985);
}
