/**
 * Auto-generated mdxfind alias module: e925 SAP-PASSCODE5
...
#include "module_07801.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e925 SAP-PASSCODE5";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (925);
}
