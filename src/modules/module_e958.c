/**
 * Auto-generated mdxfind alias module: e958 UMBRACO
...
#include "module_24800.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e958 UMBRACO";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (958);
}
