...
static const char *HASH_NAME      = "bcrypt(HMAC-SHA256($pass))";
static const u64   KERN_TYPE      = 30601;
...
static const char *ST_HASH        = "$bcrypt-sha256$v=2,t=2b,r=12$KSOjON/ciJR86a00N5q61.$AmWZucQuHk13FGkQWhgMeiFvBfm2GCy";
...
static const char *SIGNATURE_BCRYPTHMACSHA256V2T2B = "$bcrypt-sha256$v=2,t=2b,r=";
...
{
  const u64 esalt_size = (const u64) sizeof (hmac_b64_salt_t);
...
int module_hash_decode (MAYBE_UNUSED const hashconfig_t *hashconfig, MAYBE_UNUSED void *digest_buf, MAYBE_UNUSED salt_t *salt, MAYBE_UNUSED void *esalt_buf, MAYBE_UNUSED void *hook_salt_buf, MAYBE_UNUSED hashinfo_t *hash_info, const char *line_buf, MAYBE_UNUSED const int line_len)
{
  ...
  hmac_b64_salt_t *esalt = (hmac_b64_salt_t *) esalt_buf;
  ...
  token.signatures_buf[0] = SIGNATURE_BCRYPTHMACSHA256V2T2B;
  ...
  memset (esalt, 0, sizeof (hmac_b64_salt_t));
...
int module_hash_encode (MAYBE_UNUSED const hashconfig_t *hashconfig, MAYBE_UNUSED const void *digest_buf, MAYBE_UNUSED const salt_t *salt, MAYBE_UNUSED const void *esalt_buf, MAYBE_UNUSED const void *hook_salt_buf, MAYBE_UNUSED const hashinfo_t *hash_info, char *line_buf, MAYBE_UNUSED const int line_size)
{
  ...
  tmp_buf[22] = '$';
  base64_encode (int_to_bf64, (const u8 *) tmp_digest, 23, (u8 *) tmp_buf + 23);

  tmp_buf[23 + 31] = 0; // base64_encode wants to pad

  return snprintf (line_buf, line_size, "%s%d$%s", (const char *) SIGNATURE_BCRYPTHMACSHA256V2T2B, (int)log2(salt->salt_iter), tmp_buf);
}
