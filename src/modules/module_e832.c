/**
 * Auto-generated mdxfind alias module: e832 SHA224SALTPASS
...
#include "module_01320.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e832 SHA224SALTPASS";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (832);
}
