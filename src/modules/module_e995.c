/**
 * Auto-generated mdxfind alias module: e995 YESCRYPT
...
#include "module_67000.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e995 YESCRYPT";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (995);
}
