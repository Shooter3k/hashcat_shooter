/**
 * Auto-generated mdxfind alias module: e833 SSHA1BASE64
...
#include "module_00111.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e833 SSHA1BASE64";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (833);
}
