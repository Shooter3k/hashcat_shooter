/**
 * Auto-generated mdxfind alias module: e965 AES256-NOKDF
...
#include "module_26403.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e965 AES256-NOKDF";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (965);
}
