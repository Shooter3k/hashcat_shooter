/**
 * Auto-generated mdxfind alias module: e858 PEOPLESOFT
...
#include "module_00133.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e858 PEOPLESOFT";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (858);
}
