/**
 * Auto-generated mdxfind alias module: e89 SHA3-256
...
#include "module_17400.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e89 SHA3-256";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (89);
}
