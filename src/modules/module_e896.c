/**
 * Auto-generated mdxfind alias module: e896 ORACLE7
...
#include "module_03100.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e896 ORACLE7";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (896);
}
