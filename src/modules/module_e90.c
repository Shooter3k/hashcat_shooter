/**
 * Auto-generated mdxfind alias module: e90 SHA3-384
...
#include "module_17500.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e90 SHA3-384";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (90);
}
