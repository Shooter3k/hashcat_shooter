/**
 * Auto-generated mdxfind alias module: e513 SHA512CRYPT
...
#include "module_01800.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e513 SHA512CRYPT";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (513);
}
