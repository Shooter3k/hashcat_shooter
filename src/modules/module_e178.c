/**
 * Auto-generated mdxfind alias module: e178 MD5SHA1
...
#include "module_04400.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e178 MD5SHA1";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (178);
}
