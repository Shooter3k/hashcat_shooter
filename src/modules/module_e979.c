/**
 * Auto-generated mdxfind alias module: e979 SSPR-SHA512
...
#include "module_32040.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e979 SSPR-SHA512";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (979);
}
