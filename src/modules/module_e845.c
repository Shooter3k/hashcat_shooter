/**
 * Auto-generated mdxfind alias module: e845 BLAKE2B256
...
#include "module_34800.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e845 BLAKE2B256";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (845);
}
