/**
 * Auto-generated mdxfind alias module: e922 SAP-BCODE
...
#include "module_07700.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e922 SAP-BCODE";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (922);
}
