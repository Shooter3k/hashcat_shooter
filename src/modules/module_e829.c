/**
 * Auto-generated mdxfind alias module: e829 MURMUR64A
...
#include "module_34200.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e829 MURMUR64A";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (829);
}
