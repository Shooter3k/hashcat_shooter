/**
 * Auto-generated mdxfind alias module: e29 MD6256
...
#include "module_34600.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e29 MD6256";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (29);
}
