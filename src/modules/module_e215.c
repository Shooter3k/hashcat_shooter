/**
 * Auto-generated mdxfind alias module: e215 HMAC-SHA1
...
#include "module_00160.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e215 HMAC-SHA1";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (215);
}
