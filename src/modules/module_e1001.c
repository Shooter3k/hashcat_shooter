/**
 * Auto-generated mdxfind alias module: e1001 CMIYC
...
#include "module_29970.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e1001 CMIYC";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (1001);
}
