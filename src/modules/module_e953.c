/**
 * Auto-generated mdxfind alias module: e953 APPLE-IWORK
...
#include "module_23300.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e953 APPLE-IWORK";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (953);
}
