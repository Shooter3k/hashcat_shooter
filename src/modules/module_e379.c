/**
 * Auto-generated mdxfind alias module: e379 LM
...
#include "module_03000.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e379 LM";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (379);
}
