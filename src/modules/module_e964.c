/**
 * Auto-generated mdxfind alias module: e964 AES192-NOKDF
...
#include "module_26402.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e964 AES192-NOKDF";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (964);
}
