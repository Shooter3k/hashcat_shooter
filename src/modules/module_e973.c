/**
 * Auto-generated mdxfind alias module: e973 VEEAM-VBK
...
#include "module_31200.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e973 VEEAM-VBK";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (973);
}
