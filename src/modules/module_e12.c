/**
 * Auto-generated mdxfind alias module: e12 SHA512
...
#include "module_01700.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e12 SHA512";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (12);
}
