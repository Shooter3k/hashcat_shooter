/**
 * Auto-generated mdxfind alias module: e830 MURMUR64AZERO
...
#include "module_34201.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e830 MURMUR64AZERO";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (830);
}
