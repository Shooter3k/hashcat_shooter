/**
 * Auto-generated mdxfind alias module: e855 POSTGRESQL
...
#include "module_00012.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e855 POSTGRESQL";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (855);
}
