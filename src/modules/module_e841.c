/**
 * Auto-generated mdxfind alias module: e841 BLAKE2B512
...
#include "module_00600.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e841 BLAKE2B512";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (841);
}
