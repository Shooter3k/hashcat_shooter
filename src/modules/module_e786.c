/**
 * Auto-generated mdxfind alias module: e786 NTLMH
...
#include "module_01000.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e786 NTLMH";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (786);
}
