/**
 * Auto-generated mdxfind alias module: e461 APR1
...
#include "module_01600.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e461 APR1";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (461);
}
