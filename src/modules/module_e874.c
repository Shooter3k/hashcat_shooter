/**
 * Auto-generated mdxfind alias module: e874 KRB5PA23
...
#include "module_07500.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e874 KRB5PA23";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (874);
}
