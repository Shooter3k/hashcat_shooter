/**
 * Auto-generated mdxfind alias module: e929 RACF-KDFAES
...
#include "module_14200.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e929 RACF-KDFAES";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (929);
}
