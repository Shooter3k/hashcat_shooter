/**
 * Auto-generated mdxfind alias module: e956 MONGODB-SHA256
...
#include "module_24200.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e956 MONGODB-SHA256";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (956);
}
