/**
 * Auto-generated mdxfind alias module: e835 SSHA256BASE64
...
#include "module_01411.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e835 SSHA256BASE64";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (835);
}
