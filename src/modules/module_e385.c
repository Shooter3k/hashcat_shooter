/**
 * Auto-generated mdxfind alias module: e385 SHA1SALTPASS
...
#include "module_00120.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e385 SHA1SALTPASS";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (385);
}
