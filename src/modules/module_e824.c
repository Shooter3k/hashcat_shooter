/**
 * Auto-generated mdxfind alias module: e824 SHA1-SALTSHA1U16
...
#include "module_29000.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e824 SHA1-SALTSHA1U16";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (824);
}
