/**
 * Auto-generated mdxfind alias module: e86 KECCAK384
...
#include "module_17900.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e86 KECCAK384";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (86);
}
