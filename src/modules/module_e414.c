/**
 * Auto-generated mdxfind alias module: e414 SMF
...
#include "module_00121.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e414 SMF";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (414);
}
