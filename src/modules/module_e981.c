/**
 * Auto-generated mdxfind alias module: e981 PBKDF1-SHA1
...
#include "module_32900.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e981 PBKDF1-SHA1";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (981);
}
