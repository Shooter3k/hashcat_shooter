/**
 * Auto-generated mdxfind alias module: e974 MSSNTP
...
#include "module_31300.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e974 MSSNTP";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (974);
}
