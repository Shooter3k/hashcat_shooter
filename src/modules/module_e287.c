/**
 * Auto-generated mdxfind alias module: e287 SHA1MD5MD5
...
#include "module_18500.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e287 SHA1MD5MD5";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (287);
}
