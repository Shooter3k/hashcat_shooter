/**
 * Auto-generated mdxfind alias module: e793 HMAC-SHA1-KPASS
...
#include "module_00150.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e793 HMAC-SHA1-KPASS";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (793);
}
