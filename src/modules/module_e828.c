/**
 * Auto-generated mdxfind alias module: e828 HMAC-BLAKE2S
...
#include "module_33300.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e828 HMAC-BLAKE2S";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (828);
}
