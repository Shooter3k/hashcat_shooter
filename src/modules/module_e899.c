/**
 * Auto-generated mdxfind alias module: e899 LASTPASS
...
#include "module_06800.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e899 LASTPASS";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (899);
}
