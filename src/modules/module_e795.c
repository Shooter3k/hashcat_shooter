/**
 * Auto-generated mdxfind alias module: e795 HMAC-SHA256-KPASS
...
#include "module_01450.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e795 HMAC-SHA256-KPASS";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (795);
}
