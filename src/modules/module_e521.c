/**
 * Auto-generated mdxfind alias module: e521 SHA1SALTCX
...
#include "module_14400.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e521 SHA1SALTCX";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (521);
}
