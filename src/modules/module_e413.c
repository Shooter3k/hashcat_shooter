/**
 * Auto-generated mdxfind alias module: e413 SHA256PASSSALT
...
#include "module_01410.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e413 SHA256PASSSALT";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (413);
}
