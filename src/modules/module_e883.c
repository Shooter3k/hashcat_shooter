/**
 * Auto-generated mdxfind alias module: e883 DOMINO6
...
#include "module_08700.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e883 DOMINO6";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (883);
}
