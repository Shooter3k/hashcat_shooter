/**
 * Auto-generated mdxfind alias module: e934 QNX-MD5
...
#include "module_19000.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e934 QNX-MD5";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (934);
}
