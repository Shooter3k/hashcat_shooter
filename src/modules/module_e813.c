/**
 * Auto-generated mdxfind alias module: e813 SHA384UTF16LE
...
#include "module_10870.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e813 SHA384UTF16LE";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (813);
}
