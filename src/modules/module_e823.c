/**
 * Auto-generated mdxfind alias module: e823 SHA1-SALTSHA1PASSSALT
...
#include "module_24300.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e823 SHA1-SALTSHA1PASSSALT";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (823);
}
