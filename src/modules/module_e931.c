/**
 * Auto-generated mdxfind alias module: e931 APPLE-SECURE-NOTES
...
#include "module_16200.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e931 APPLE-SECURE-NOTES";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (931);
}
