/**
 * Auto-generated mdxfind alias module: e951 SIMPLACMS
...
#include "module_22800.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e951 SIMPLACMS";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (951);
}
