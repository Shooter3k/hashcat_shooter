/**
 * Auto-generated mdxfind alias module: e838 HMAC-STREEBOG256
...
#include "module_11760.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e838 HMAC-STREEBOG256";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (838);
}
