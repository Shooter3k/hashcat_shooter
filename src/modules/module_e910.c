/**
 * Auto-generated mdxfind alias module: e910 ORACLE12
...
#include "module_12300.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e910 ORACLE12";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (910);
}
