/**
 * Auto-generated mdxfind alias module: e469 SHA1MD5PASSSALT
...
#include "module_21100.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e469 SHA1MD5PASSSALT";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (469);
}
