/**
 * Auto-generated mdxfind alias module: e38 SHA512RAW
...
#include "module_21000.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e38 SHA512RAW";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (38);
}
