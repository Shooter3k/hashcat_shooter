/**
 * Auto-generated mdxfind alias module: e961 SQLCIPHER
...
#include "module_24600.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e961 SQLCIPHER";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (961);
}
