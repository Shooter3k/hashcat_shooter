/**
 * Auto-generated mdxfind alias module: e577 BCRYPT256
...
#include "module_30600.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e577 BCRYPT256";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (577);
}
