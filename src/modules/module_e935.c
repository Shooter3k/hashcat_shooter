/**
 * Auto-generated mdxfind alias module: e935 QNX-SHA256
...
#include "module_19100.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e935 QNX-SHA256";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (935);
}
