/**
 * Auto-generated mdxfind alias module: e766 SHA224SHA1
...
#include "module_34500.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e766 SHA224SHA1";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (766);
}
