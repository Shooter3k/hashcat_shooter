/**
 * Auto-generated mdxfind alias module: e214 HMAC-MD5
...
#include "module_00060.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e214 HMAC-MD5";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (214);
}
