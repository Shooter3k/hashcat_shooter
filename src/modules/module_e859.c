/**
 * Auto-generated mdxfind alias module: e859 EPISERVER
...
#include "module_00141.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e859 EPISERVER";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (859);
}
