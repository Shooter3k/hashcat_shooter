/**
 * Auto-generated mdxfind alias module: e881 RACF
...
#include "module_08500.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e881 RACF";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (881);
}
