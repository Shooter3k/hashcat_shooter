/**
 * Auto-generated mdxfind alias module: e812 SHA384SALTPASS
...
#include "module_10820.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e812 SHA384SALTPASS";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (812);
}
