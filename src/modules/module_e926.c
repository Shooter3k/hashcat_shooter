/**
 * Auto-generated mdxfind alias module: e926 AS400-DES
...
#include "module_08501.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e926 AS400-DES";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (926);
}
