/**
 * Auto-generated mdxfind alias module: e808 SHA512UTF16LE
...
#include "module_01770.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e808 SHA512UTF16LE";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (808);
}
