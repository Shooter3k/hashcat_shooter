/**
 * Auto-generated mdxfind alias module: e510 SHA512SHA512RAWUSER
...
#include "module_32420.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e510 SHA512SHA512RAWUSER";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (510);
}
