/**
 * Auto-generated mdxfind alias module: e871 AIX-SHA512
...
#include "module_06500.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e871 AIX-SHA512";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (871);
}
