/**
 * Auto-generated mdxfind alias module: e941 KRB5PA-18
...
#include "module_19900.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e941 KRB5PA-18";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (941);
}
