/**
 * Auto-generated mdxfind alias module: e873 IPMI2-MD5
...
#include "module_07350.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e873 IPMI2-MD5";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (873);
}
