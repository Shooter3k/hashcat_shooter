/**
 * Auto-generated mdxfind alias module: e834 SHA1PASSHEXSALT
...
#include "module_00112.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e834 SHA1PASSHEXSALT";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (834);
}
