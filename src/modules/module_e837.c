/**
 * Auto-generated mdxfind alias module: e837 HMAC-STREEBOG256-KPASS
...
#include "module_11750.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e837 HMAC-STREEBOG256-KPASS";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (837);
}
