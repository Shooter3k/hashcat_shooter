/**
 * Auto-generated mdxfind alias module: e861 CISCOPIX
...
#include "module_02400.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e861 CISCOPIX";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (861);
}
