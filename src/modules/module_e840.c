/**
 * Auto-generated mdxfind alias module: e840 HMAC-STREEBOG512
...
#include "module_11860.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e840 HMAC-STREEBOG512";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (840);
}
