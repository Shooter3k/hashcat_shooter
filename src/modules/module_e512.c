/**
 * Auto-generated mdxfind alias module: e512 SHA256CRYPT
...
#include "module_07400.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e512 SHA256CRYPT";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (512);
}
