/**
 * Auto-generated mdxfind alias module: e809 SHA512UTF16LEPASSSALT
...
#include "module_01730.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e809 SHA512UTF16LEPASSSALT";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (809);
}
