/**
 * Auto-generated mdxfind alias module: e800 MD5UTF16LE
...
#include "module_00070.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e800 MD5UTF16LE";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (800);
}
