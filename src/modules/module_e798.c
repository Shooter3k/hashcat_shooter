/**
 * Auto-generated mdxfind alias module: e798 HMAC-RMD160-KPASS
...
#include "module_06050.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e798 HMAC-RMD160-KPASS";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (798);
}
