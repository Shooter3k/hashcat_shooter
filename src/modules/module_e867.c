/**
 * Auto-generated mdxfind alias module: e867 SAMSUNGSHA1
...
#include "module_05800.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e867 SAMSUNGSHA1";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (867);
}
