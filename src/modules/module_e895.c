/**
 * Auto-generated mdxfind alias module: e895 NETSCALER-PBKDF2
...
#include "module_33900.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e895 NETSCALER-PBKDF2";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (895);
}
