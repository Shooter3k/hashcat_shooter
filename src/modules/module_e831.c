/**
 * Auto-generated mdxfind alias module: e831 SHA224PASSSALT
...
#include "module_01310.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e831 SHA224PASSSALT";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (831);
}
