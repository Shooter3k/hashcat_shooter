/**
 * Auto-generated mdxfind alias module: e452 BCRYPTSHA1
...
#include "module_25800.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e452 BCRYPTSHA1";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (452);
}
