/**
 * Auto-generated mdxfind alias module: e932 CRAMMD5-DOVECOT
...
#include "module_16400.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e932 CRAMMD5-DOVECOT";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (932);
}
