/**
 * Auto-generated mdxfind alias module: e826 SHA256-SALTSHA256RAW
...
#include "module_21420.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e826 SHA256-SALTSHA256RAW";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (826);
}
