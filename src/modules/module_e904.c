/**
 * Auto-generated mdxfind alias module: e904 SAPCODVNH
...
#include "module_10300.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e904 SAPCODVNH";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (904);
}
