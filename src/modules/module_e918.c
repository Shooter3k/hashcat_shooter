/**
 * Auto-generated mdxfind alias module: e918 DCC2
...
#include "module_02100.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e918 DCC2";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (918);
}
