/**
 * Auto-generated mdxfind alias module: e948 WEB2PY-SHA512
...
#include "module_21600.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e948 WEB2PY-SHA512";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (948);
}
