/**
 * Auto-generated mdxfind alias module: e440 MD5SHA1SALTMD5PASS
...
#include "module_21200.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e440 MD5SHA1SALTMD5PASS";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (440);
}
