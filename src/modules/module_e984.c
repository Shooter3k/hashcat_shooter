/**
 * Auto-generated mdxfind alias module: e984 SAPCODVNH512
...
#include "module_35000.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e984 SAPCODVNH512";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (984);
}
