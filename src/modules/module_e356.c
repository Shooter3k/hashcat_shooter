/**
 * Auto-generated mdxfind alias module: e356 MD5MD5MD5USER
...
#include "module_03610.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e356 MD5MD5MD5USER";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (356);
}
