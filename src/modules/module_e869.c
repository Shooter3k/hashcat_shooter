/**
 * Auto-generated mdxfind alias module: e869 AIX-SHA1
...
#include "module_06700.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e869 AIX-SHA1";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (869);
}
