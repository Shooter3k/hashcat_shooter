/**
 * Auto-generated mdxfind alias module: e84 KECCAK224
...
#include "module_17700.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e84 KECCAK224";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (84);
}
