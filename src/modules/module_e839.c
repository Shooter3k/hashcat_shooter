/**
 * Auto-generated mdxfind alias module: e839 HMAC-STREEBOG512-KPASS
...
#include "module_11850.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e839 HMAC-STREEBOG512-KPASS";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (839);
}
