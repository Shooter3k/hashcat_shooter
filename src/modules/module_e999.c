/**
 * Auto-generated mdxfind alias module: e999 SHA1CRYPT
...
#include "module_15100.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e999 SHA1CRYPT";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (999);
}
