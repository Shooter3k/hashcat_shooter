/**
 * Auto-generated mdxfind alias module: e500 DESCRYPT
...
#include "module_01500.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e500 DESCRYPT";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (500);
}
