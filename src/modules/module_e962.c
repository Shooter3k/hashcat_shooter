/**
 * Auto-generated mdxfind alias module: e962 RORAILS-SHA1
...
#include "module_27200.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e962 RORAILS-SHA1";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (962);
}
