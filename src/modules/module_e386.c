/**
 * Auto-generated mdxfind alias module: e386 SHA512PASSSALT
...
#include "module_01710.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e386 SHA512PASSSALT";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (386);
}
