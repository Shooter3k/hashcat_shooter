/**
 * Auto-generated mdxfind alias module: e810 SHA512UTF16LESALTPASS
...
#include "module_01740.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e810 SHA512UTF16LESALTPASS";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (810);
}
