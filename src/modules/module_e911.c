/**
 * Auto-generated mdxfind alias module: e911 COLDFUSION10
...
#include "module_12600.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e911 COLDFUSION10";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (911);
}
