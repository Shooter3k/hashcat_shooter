/**
 * Auto-generated mdxfind alias module: e91 SHA3-512
...
#include "module_17600.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e91 SHA3-512";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (91);
}
