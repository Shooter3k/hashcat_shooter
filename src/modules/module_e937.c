/**
 * Auto-generated mdxfind alias module: e937 QNX7-SHA512
...
#include "module_19210.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e937 QNX7-SHA512";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (937);
}
