/**
 * Auto-generated mdxfind alias module: e933 JWT
...
#include "module_16500.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e933 JWT";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (933);
}
