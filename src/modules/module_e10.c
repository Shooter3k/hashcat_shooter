/**
 * Auto-generated mdxfind alias module: e10 SHA256
...
#include "module_01400.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e10 SHA256";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (10);
}
