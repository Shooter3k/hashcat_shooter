/**
 * Auto-generated mdxfind alias module: e978 SSPR-SHA256
...
#include "module_32030.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e978 SSPR-SHA256";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (978);
}
