/**
 * Auto-generated mdxfind alias module: e923 SAP-BCODE4
...
#include "module_07701.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e923 SAP-BCODE4";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (923);
}
