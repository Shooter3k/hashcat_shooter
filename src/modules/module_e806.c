/**
 * Auto-generated mdxfind alias module: e806 SHA256UTF16LEPASSSALT
...
#include "module_01430.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e806 SHA256UTF16LEPASSSALT";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (806);
}
