/**
 * Auto-generated mdxfind alias module: e947 TELEGRAM-SHA256
...
#include "module_22301.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e947 TELEGRAM-SHA256";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (947);
}
