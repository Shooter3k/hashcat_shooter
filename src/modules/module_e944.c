/**
 * Auto-generated mdxfind alias module: e944 ANSIBLE-VAULT
...
#include "module_16900.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e944 ANSIBLE-VAULT";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (944);
}
