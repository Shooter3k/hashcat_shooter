/**
 * Auto-generated mdxfind alias module: e993 WPBCRYPT
...
#include "module_35500.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e993 WPBCRYPT";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (993);
}
