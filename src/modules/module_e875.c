/**
 * Auto-generated mdxfind alias module: e875 MYSQL-SHA256CRYPT
...
#include "module_07401.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e875 MYSQL-SHA256CRYPT";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (875);
}
