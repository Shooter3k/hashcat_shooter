/**
 * Auto-generated mdxfind alias module: e451 BCRYPTMD5
...
#include "module_25600.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e451 BCRYPTMD5";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (451);
}
