/**
 * Auto-generated mdxfind alias module: e1000 7ZIP
...
#include "module_11600.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e1000 7ZIP";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (1000);
}
