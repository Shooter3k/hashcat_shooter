/**
 * Auto-generated mdxfind alias module: e9 SHA224
...
#include "module_01300.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e9 SHA224";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (9);
}
