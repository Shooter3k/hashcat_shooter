/**
 * Auto-generated mdxfind alias module: e844 BLAKE2S256
...
#include "module_31000.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e844 BLAKE2S256";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (844);
}
