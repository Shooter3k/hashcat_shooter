/**
 * Auto-generated mdxfind alias module: e815 SHA384UTF16LESALTPASS
...
#include "module_10840.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e815 SHA384UTF16LESALTPASS";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (815);
}
