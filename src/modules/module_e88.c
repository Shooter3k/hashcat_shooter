/**
 * Auto-generated mdxfind alias module: e88 SHA3-224
...
#include "module_17300.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e88 SHA3-224";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (88);
}
