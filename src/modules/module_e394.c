/**
 * Auto-generated mdxfind alias module: e394 MD5SALTPASS
...
#include "module_00020.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e394 MD5SALTPASS";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (394);
}
