/**
 * Auto-generated mdxfind alias module: e909 ECRYPTFS
...
#include "module_12200.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e909 ECRYPTFS";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (909);
}
