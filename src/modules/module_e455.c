/**
 * Auto-generated mdxfind alias module: e455 PHPBB3
...
#include "module_00400.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e455 PHPBB3";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (455);
}
