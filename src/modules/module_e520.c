/**
 * Auto-generated mdxfind alias module: e520 SHA1SALTSHA1PASS
...
#include "module_04520.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e520 SHA1SALTSHA1PASS";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (520);
}
