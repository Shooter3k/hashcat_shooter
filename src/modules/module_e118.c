/**
 * Auto-generated mdxfind alias module: e118 RIPEMD
...
#include "module_06000.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e118 RIPEMD";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (118);
}
