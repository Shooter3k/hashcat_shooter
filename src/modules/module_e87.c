/**
 * Auto-generated mdxfind alias module: e87 KECCAK512
...
#include "module_18000.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e87 KECCAK512";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (87);
}
