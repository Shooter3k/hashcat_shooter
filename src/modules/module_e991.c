/**
 * Auto-generated mdxfind alias module: e991 MD5SALT1SALT2
...
#include "module_33000.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e991 MD5SALT1SALT2";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (991);
}
