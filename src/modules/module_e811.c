/**
 * Auto-generated mdxfind alias module: e811 SHA384PASSSALT
...
#include "module_10810.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e811 SHA384PASSSALT";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (811);
}
