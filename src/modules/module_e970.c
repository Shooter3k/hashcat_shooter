/**
 * Auto-generated mdxfind alias module: e970 KRB5DB17
...
#include "module_28800.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e970 KRB5DB17";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (970);
}
