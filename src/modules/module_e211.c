/**
 * Auto-generated mdxfind alias module: e211 HMAC-RMD160
...
#include "module_06060.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e211 HMAC-RMD160";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (211);
}
