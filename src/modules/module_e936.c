/**
 * Auto-generated mdxfind alias module: e936 QNX-SHA512
...
#include "module_19200.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e936 QNX-SHA512";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (936);
}
