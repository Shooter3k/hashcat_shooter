/**
 * Auto-generated mdxfind alias module: e427 GOST2012-32
...
#include "module_11700.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e427 GOST2012-32";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (427);
}
