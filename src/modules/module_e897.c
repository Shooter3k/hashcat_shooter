/**
 * Auto-generated mdxfind alias module: e897 NETNTLMV1
...
#include "module_05500.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e897 NETNTLMV1";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (897);
}
