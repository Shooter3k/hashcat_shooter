/**
 * Auto-generated mdxfind alias module: e852 MSSQL2012
...
#include "module_01731.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e852 MSSQL2012";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (852);
}
