/**
 * Auto-generated mdxfind alias module: e441 MD5SALTMD5PASS
...
#include "module_03710.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e441 MD5SALTMD5PASS";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (441);
}
