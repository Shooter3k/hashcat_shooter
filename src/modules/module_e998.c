/**
 * Auto-generated mdxfind alias module: e998 GOST-YESCRYPT
...
#include "module_36200.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e998 GOST-YESCRYPT";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (998);
}
