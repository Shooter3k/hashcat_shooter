/**
 * Auto-generated mdxfind alias module: e902 SIPHASH
...
#include "module_10100.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e902 SIPHASH";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (902);
}
