/**
 * Auto-generated mdxfind alias module: e916 AXCRYPTSHA1
...
#include "module_13300.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e916 AXCRYPTSHA1";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (916);
}
