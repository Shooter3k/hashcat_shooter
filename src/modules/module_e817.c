/**
 * Auto-generated mdxfind alias module: e817 MD5-SHA1SALTPASS
...
#include "module_04430.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e817 MD5-SHA1SALTPASS";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (817);
}
