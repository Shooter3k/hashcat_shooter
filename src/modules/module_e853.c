/**
 * Auto-generated mdxfind alias module: e853 MACOSX
...
#include "module_00122.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e853 MACOSX";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (853);
}
