/**
 * Auto-generated mdxfind alias module: e872 IPMI2-SHA1
...
#include "module_07300.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e872 IPMI2-SHA1";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (872);
}
