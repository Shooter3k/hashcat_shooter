/**
 * Auto-generated mdxfind alias module: e428 GOST2012-64
...
#include "module_11800.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e428 GOST2012-64";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (428);
}
