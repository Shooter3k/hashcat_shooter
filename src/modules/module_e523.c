/**
 * Auto-generated mdxfind alias module: e523 SHA256SALTSHA256PASS
...
#include "module_20720.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e523 SHA256SALTSHA256PASS";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (523);
}
