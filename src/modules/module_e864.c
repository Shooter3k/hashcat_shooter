/**
 * Auto-generated mdxfind alias module: e864 DAHUA
...
#include "module_03730.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e864 DAHUA";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (864);
}
