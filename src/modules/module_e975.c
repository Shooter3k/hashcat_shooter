/**
 * Auto-generated mdxfind alias module: e975 SSPR-MD5
...
#include "module_32000.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e975 SSPR-MD5";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (975);
}
