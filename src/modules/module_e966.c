/**
 * Auto-generated mdxfind alias module: e966 VMWARE-VMX
...
#include "module_27400.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e966 VMWARE-VMX";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (966);
}
