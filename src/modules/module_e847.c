/**
 * Auto-generated mdxfind alias module: e847 BLAKE2B256SALTPASS
...
#include "module_34820.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e847 BLAKE2B256SALTPASS";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (847);
}
