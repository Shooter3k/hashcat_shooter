/**
 * Auto-generated mdxfind alias module: e997 BSDICRYPT
...
#include "module_12400.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e997 BSDICRYPT";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (997);
}
