/**
 * Auto-generated mdxfind alias module: e879 NSEC3
...
#include "module_08300.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e879 NSEC3";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (879);
}
