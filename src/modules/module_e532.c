/**
 * Auto-generated mdxfind alias module: e532 PBKDF2-SHA1
...
#include "module_12000.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e532 PBKDF2-SHA1";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (532);
}
