/**
 * Auto-generated mdxfind alias module: e924 SAP-PASSCODE
...
#include "module_07800.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e924 SAP-PASSCODE";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (924);
}
