/**
 * Auto-generated mdxfind alias module: e994 GOST12512CRYPT
...
#include "module_35600.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e994 GOST12512CRYPT";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (994);
}
