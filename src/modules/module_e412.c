/**
 * Auto-generated mdxfind alias module: e412 SHA256SALTPASS
...
#include "module_01420.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e412 SHA256SALTPASS";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (412);
}
