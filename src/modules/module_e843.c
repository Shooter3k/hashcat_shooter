/**
 * Auto-generated mdxfind alias module: e843 BLAKE2B512SALTPASS
...
#include "module_00620.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e843 BLAKE2B512SALTPASS";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (843);
}
