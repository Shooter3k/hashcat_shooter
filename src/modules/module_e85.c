/**
 * Auto-generated mdxfind alias module: e85 KECCAK256
...
#include "module_17800.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e85 KECCAK256";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (85);
}
