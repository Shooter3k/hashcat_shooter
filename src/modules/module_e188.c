/**
 * Auto-generated mdxfind alias module: e188 MD5SHA1MD5
...
#include "module_32800.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e188 MD5SHA1MD5";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (188);
}
