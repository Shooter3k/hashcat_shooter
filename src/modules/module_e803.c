/**
 * Auto-generated mdxfind alias module: e803 SHA1UTF16LEPASSSALT
...
#include "module_00130.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e803 SHA1UTF16LEPASSSALT";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (803);
}
