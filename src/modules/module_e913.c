/**
 * Auto-generated mdxfind alias module: e913 ANDROIDFDE
...
#include "module_12900.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e913 ANDROIDFDE";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (913);
}
