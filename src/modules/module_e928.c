/**
 * Auto-generated mdxfind alias module: e928 WINPHONE
...
#include "module_13800.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e928 WINPHONE";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (928);
}
