/**
 * Auto-generated mdxfind alias module: e880 WBB3
...
#include "module_08400.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e880 WBB3";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (880);
}
