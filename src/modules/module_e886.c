/**
 * Auto-generated mdxfind alias module: e886 PHPS
...
#include "module_02612.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e886 PHPS";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (886);
}
