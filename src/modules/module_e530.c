/**
 * Auto-generated mdxfind alias module: e530 PBKDF2-SHA256
...
#include "module_10000.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e530 PBKDF2-SHA256";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (530);
}
