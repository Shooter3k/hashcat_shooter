/**
 * Auto-generated mdxfind alias module: e903 CRAMMD5
...
#include "module_10200.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e903 CRAMMD5";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (903);
}
