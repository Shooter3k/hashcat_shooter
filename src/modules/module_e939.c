/**
 * Auto-generated mdxfind alias module: e939 RAILS-RESTFUL
...
#include "module_19500.c"
#undef module_init

static const char *MDXFIND_HASH_NAME = "mdxfind e939 RAILS-RESTFUL";
...
{
  return MDXFIND_HASH_MODE_FROM_ID (939);
}
