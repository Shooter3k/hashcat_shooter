...
static const char *const USAGE_BIG_POST_HASHMODES[] =
{
  ...
  "  8 | Generic",
  "  9 | Association",
  " 11 | Combination (3-way)",
  " 12 | Combination (4-way)",
  " 13 | Combination (5-way)",
  " 14 | Combination (6-way)",
  "",
  "- [ Built-in Charsets ] -",
  "",
  "  ? | Charset",
  ...
  "  Combinator (3way) | MD5   | hashcat -a 11 -m 0 example0.hash example.dict example.dict example.dict",
  "  Combinator (4way) | MD5   | hashcat -a 12 -m 0 example0.hash example.dict example.dict example.dict example.dict",
  "  Combinator (5way) | MD5   | hashcat -a 13 -m 0 example0.hash example.dict example.dict example.dict example.dict example.dict",
  "  Combinator (6way) | MD5   | hashcat -a 14 -m 0 example0.hash example.dict example.dict example.dict example.dict example.dict example.dict",
