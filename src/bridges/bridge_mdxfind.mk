...
bridges/bridge_mdxfind.so: $(MDXFIND_BRIDGE_SOURCES) $(MDXFIND_ARCHIVES_LINUX) obj/combined.LINUX.a
...
bridges/bridge_mdxfind.dll: $(MDXFIND_BRIDGE_SOURCES) $(MDXFIND_ARCHIVES_WIN) obj/combined.WIN.a
...
ifeq ($(SHARED),1)
bridges/bridge_mdxfind.$(BRIDGE_SUFFIX): $(MDXFIND_BRIDGE_SOURCES) $(MDXFIND_ARCHIVES_NATIVE) $(HASHCAT_LIBRARY)
...
bridges/bridge_mdxfind.$(BRIDGE_SUFFIX): $(MDXFIND_BRIDGE_SOURCES) $(MDXFIND_ARCHIVES_NATIVE) obj/combined.NATIVE.a
	$(CC) $(CCFLAGS) $(CFLAGS_NATIVE) $(MDXFIND_BRIDGE_FLAGS) $^ -o $@ $(LFLAGS_NATIVE) -shared -fPIC -D BRIDGE_INTERFACE_VERSION_CURRENT=$(BRIDGE_INTERFACE_VERSION) $(MDXFIND_BRIDGE_LIBS_NATIVE)
endif
endif
